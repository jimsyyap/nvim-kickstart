...
vim.keymap.set('n', 'hh', '<cmd>nohlsearch<CR>')
...
require('lazy').setup({
  ...
  -- vim-sleuth commented out 14-may2024
  -- vim-sleuth added spaces on the emmet snippet.
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- See `:help telescope.builtin` or, howtosearch
